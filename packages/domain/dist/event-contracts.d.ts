...
export type ExtensionEvent = {
    ...
    type: "PROMPT_CHANGED";
    payload: PromptChangedPayload;
} | {
    type: "PROMPT_SUBMITTED";
    payload: PromptSubmittedPayload;
} | {
    type: "REQUEST_SUGGESTIONS";
    payload: RequestSuggestionsPayload;
} | {
    type: "SUGGESTIONS_READY";
    payload: SuggestionsReadyPayload;
} | {
    type: "SUGGESTION_ACCEPTED";
    payload: SuggestionAcceptedPayload;
} | {
    type: "SUGGESTION_DISMISSED";
    payload: SuggestionDismissedPayload;
} | {
    type: "VERSION_SAVED";
    payload: VersionSavedPayload;
} | {
